...
if (empty($id)) {
    die("Error: No se proporcionó un ID de precio válido.");
}

try {

    // 2. Traemos los datos actuales desde MySQL
    // CAMBIA LOS CAMPOS SEGÚN TU TABLA PRECIOS
    ...
    if (!$fila) {
        die("Error: El precio seleccionado no existe.");
    }
